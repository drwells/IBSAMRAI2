//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-4-4/source/mathops/cell/HierarchyCellDataOpsReal.h $
...
/**
 * Class HierarchyCellDataOpsReal<DIM> provides a collection of operations
 ...
 * PatchCellDataOpsReal<DIM> data member.
 * 
 ...
 * HierarchyCellDataOpsComplex<DIM> and HierarchyCellDataOpsInteger<DIM>, 
 * respectively.
 * 
...
class HierarchyCellDataOpsReal : public HierarchyDataOpsReal<DIM,TYPE>
{
public:
   /**
    * The constructor for the HierarchyCellDataOpsReal<DIM> class sets
    ...
    */
   HierarchyCellDataOpsReal(tbox::Pointer< hier::PatchHierarchy<DIM> > hierarchy,
...
private:
   ...
   int  d_finest_level; 
   PatchCellDataOpsReal<DIM,TYPE> d_patch_ops;
