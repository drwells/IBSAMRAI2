//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-4-4/source/mathops/cell/PatchCellDataBasicOps.h $
...
/**
 * Class PatchCellDataBasicOps<DIM> provides access to a collection 
...
public:
    ...
    */
   void scale(tbox::Pointer< pdat::CellData<DIM,TYPE> >& dst,
              const TYPE& alpha,
    ...
    */
   void addScalar(tbox::Pointer< pdat::CellData<DIM,TYPE> >& dst,
                  const tbox::Pointer< pdat::CellData<DIM,TYPE> >& src,
                  const TYPE& alpha,
                  const hier::Box<DIM>& box) const;
    ...
    */
   void add(tbox::Pointer< pdat::CellData<DIM,TYPE> >& dst,
    ...
    * Set dst = src1 - src2, elementwise.
    */
   void subtract(tbox::Pointer< pdat::CellData<DIM,TYPE> >& dst,
                 const tbox::Pointer< pdat::CellData<DIM,TYPE> >& src1,
                 const tbox::Pointer< pdat::CellData<DIM,TYPE> >& src2,
                 const hier::Box<DIM>& box) const;
    ...
    * Set dst = src1 * src2, elementwise.
    */
   void multiply(tbox::Pointer< pdat::CellData<DIM,TYPE> >& dst,
                 const tbox::Pointer< pdat::CellData<DIM,TYPE> >& src1,
                 const tbox::Pointer< pdat::CellData<DIM,TYPE> >& src2,
                 const hier::Box<DIM>& box) const;
    ...
    */
   void divide(tbox::Pointer< pdat::CellData<DIM,TYPE> >& dst,
               const tbox::Pointer< pdat::CellData<DIM,TYPE> >& src1,
               const tbox::Pointer< pdat::CellData<DIM,TYPE> >& src2,
               const hier::Box<DIM>& box) const;
    ...
    */
   void reciprocal(tbox::Pointer< pdat::CellData<DIM,TYPE> >& dst,
                   const tbox::Pointer< pdat::CellData<DIM,TYPE> >& src,
                   const hier::Box<DIM>& box) const;
    ...
    */
   void linearSum(tbox::Pointer< pdat::CellData<DIM,TYPE> >& dst,
                  const TYPE& alpha,
                  const tbox::Pointer< pdat::CellData<DIM,TYPE> >& src1,
                  const TYPE& beta,
                  const tbox::Pointer< pdat::CellData<DIM,TYPE> >& src2,
    ...
    */
   void axpy(tbox::Pointer< pdat::CellData<DIM,TYPE> >& dst,
             const TYPE& alpha,
             const tbox::Pointer< pdat::CellData<DIM,TYPE> >& src1,
             const tbox::Pointer< pdat::CellData<DIM,TYPE> >& src2,
             const hier::Box<DIM>& box) const;
    ...
    * Set dst = alpha * src1 - src2, elementwise.
    */ 
   void axmy(tbox::Pointer< pdat::CellData<DIM,TYPE> >& dst,
             const TYPE& alpha,
             const tbox::Pointer< pdat::CellData<DIM,TYPE> >& src1,
             const tbox::Pointer< pdat::CellData<DIM,TYPE> >& src2,
             const hier::Box<DIM>& box) const;
    ...
    */
   TYPE min(const tbox::Pointer< pdat::CellData<DIM,TYPE> >& data,
            const hier::Box<DIM>& box) const;
    ...
    */
   TYPE max(const tbox::Pointer< pdat::CellData<DIM,TYPE> >& data,
            const hier::Box<DIM>& box) const;
    ...
    */
   void setRandomValues(tbox::Pointer< pdat::CellData<DIM,TYPE> >& dst,
                        const TYPE& width,
                        const TYPE& low,
                        const hier::Box<DIM>& box) const;
...
private:
   PatchCellDataBasicOps(
      const PatchCellDataBasicOps<DIM,TYPE>&) = delete;
   void operator=(const PatchCellDataBasicOps<DIM,TYPE>&) = delete;
