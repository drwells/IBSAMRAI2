//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-4-4/source/mathops/cell/PatchCellDataNormOpsReal.h $
...
/**
 * Class PatchCellDataNormOpsReal<DIM> provides a collection of common 
 ...
 * to define part of the interface for an PatchCellDataOpsReal<DIM> object 
 ...
 * PatchCellDataNormOpsComplex<DIM>.
 *
...
public:
    ...
    * in the given box.
    */
   int numberOfEntries(const tbox::Pointer< pdat::CellData<DIM,TYPE> >& data,
    ...
    */
   void abs(tbox::Pointer< pdat::CellData<DIM,TYPE> >& dst,
   ...
   double L1Norm(
      ...
      const tbox::Pointer< pdat::CellData<DIM,double> > cvol = NULL) const;
...
private:
   PatchCellDataNormOpsReal(
      const PatchCellDataNormOpsReal<DIM,TYPE>&) = delete;
   void operator=(const PatchCellDataNormOpsReal<DIM,TYPE>&) = delete;
