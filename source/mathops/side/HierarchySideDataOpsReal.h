//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-4-4/source/mathops/side/HierarchySideDataOpsReal.h $
...
/**
 * Class HierarchySideDataOpsReal<DIM> provides a collection of operations
 ...
 * PatchSideDataOpsReal<DIM> data member.
 *
 ...
 * HierarchySideDataOpsComplex<DIM> and HierarchySideDataOpsInteger<DIM>, 
 * respectively.
 * 
...
class HierarchySideDataOpsReal : public HierarchyDataOpsReal<DIM,TYPE>
{
public:
   /**
    * The constructor for the HierarchySideDataOpsReal<DIM> class sets
    ...
    */
   HierarchySideDataOpsReal(tbox::Pointer< hier::PatchHierarchy<DIM> > hierarchy,
