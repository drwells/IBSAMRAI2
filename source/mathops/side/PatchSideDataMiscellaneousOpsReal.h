//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-4-4/source/mathops/side/PatchSideDataMiscellaneousOpsReal.h $
...
/**
 * Class PatchSideDataMiscellaneousOpsReal<DIM> provides access to a 
 ...
 * PatchSideDataOpsReal<DIM> which provides access to a more complete 
...
public:
    ...
    */
   int computeConstrProdPos(const tbox::Pointer< pdat::SideData<DIM,TYPE> >& data1, 
                            const tbox::Pointer< pdat::SideData<DIM,TYPE> >& data2,
                            const hier::Box<DIM>& box, 
                            const tbox::Pointer< pdat::SideData<DIM,double> > cvol =
                                  ((pdat::SideData<DIM,double>*)NULL)) const;
    ...
    */
   void compareToScalar(tbox::Pointer< pdat::SideData<DIM,TYPE> >& dst, 
    ...
    */
   int testReciprocal(tbox::Pointer< pdat::SideData<DIM,TYPE> >& dst, 
                      const tbox::Pointer< pdat::SideData<DIM,TYPE> >& src,
                      const hier::Box<DIM>& box, 
                      const tbox::Pointer< pdat::SideData<DIM,double> > cvol =
                            ((pdat::SideData<DIM,double>*)NULL)) const;
    ...
    */
   TYPE 
   maxPointwiseDivide(const tbox::Pointer< pdat::SideData<DIM,TYPE> >& numer,
    ...
    */
   TYPE 
   minPointwiseDivide(const tbox::Pointer< pdat::SideData<DIM,TYPE> >& numer,
		      const tbox::Pointer< pdat::SideData<DIM,TYPE> >& denom,
		      const hier::Box<DIM>& box) const;
...
private:
   PatchSideDataMiscellaneousOpsReal(
      const PatchSideDataMiscellaneousOpsReal<DIM,TYPE>&) = delete;
   void operator=(const PatchSideDataMiscellaneousOpsReal<DIM,TYPE>&) = delete;
