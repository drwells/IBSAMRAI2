//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-4-4/source/mathops/edge/HierarchyEdgeDataOpsReal.h $
...
/**
 * Class HierarchyEdgeDataOpsReal<DIM> provides a collection of operations
 ...
 * PatchEdgeDataOpsReal<DIM> data member.
 *
 ...
 * HierarchyEdgeDataOpsComplex<DIM> and HierarchyEdgeDataOpsInteger<DIM>, 
 * respectively.
 * 
...
class HierarchyEdgeDataOpsReal : public HierarchyDataOpsReal<DIM,TYPE>
{
public:
   /**
    * The constructor for the HierarchyEdgeDataOpsReal<DIM> class sets
...
private:
   HierarchyEdgeDataOpsReal(
      const HierarchyEdgeDataOpsReal<DIM,TYPE>&) = delete;
   void operator=(const HierarchyEdgeDataOpsReal<DIM,TYPE>&) = delete;
