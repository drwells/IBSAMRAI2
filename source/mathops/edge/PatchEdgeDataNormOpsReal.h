//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-4-4/source/mathops/edge/PatchEdgeDataNormOpsReal.h $
...
/**
 * Class PatchEdgeDataNormOpsReal<DIM> provides a collection of common 
 ...
 * to define part of the interface for an PatchEdgeDataOpsReal<DIM> object 
 ...
 * PatchEdgeDataNormOpsComplex<DIM>.
 *
...
public:
    ...
    */
   int numberOfEntries(const tbox::Pointer< pdat::EdgeData<DIM,TYPE> >& data,
    ...
    */
   void abs(tbox::Pointer< pdat::EdgeData<DIM,TYPE> >& dst,
   ...
   double L1Norm(
      ...
      const tbox::Pointer< pdat::EdgeData<DIM,double> > cvol = NULL) const;
