//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-4-4/source/mathops/node/PatchNodeDataNormOpsReal.h $
...
/**
 * Class PatchNodeDataNormOpsReal<DIM> provides a collection of common 
 ...
 * to define part of the interface for an PatchNodeDataOpsReal<DIM> object 
 ...
 * PatchNodeDataNormOpsComplex<DIM>.
 *
...
public:
    ...
    */
   int numberOfEntries(const tbox::Pointer< pdat::NodeData<DIM,TYPE> >& data,
    ...
    */
   void abs(tbox::Pointer< pdat::NodeData<DIM,TYPE> >& dst,
   ...
   double L1Norm(
      ...
      const tbox::Pointer< pdat::NodeData<DIM,double> > cvol = NULL) const;
...
private:
   PatchNodeDataNormOpsReal(
      const PatchNodeDataNormOpsReal<DIM,TYPE>&) = delete;
   void operator=(const PatchNodeDataNormOpsReal<DIM,TYPE>&) = delete;
