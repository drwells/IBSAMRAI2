//
// File:	$URL: file:///usr/casc/samrai/repository/SAMRAI/tags/v-2-4-4/source/mathops/node/HierarchyNodeDataOpsReal.h $
...
/**
 * Class HierarchyNodeDataOpsReal<DIM> provides a collection of operations
 ...
 * PatchNodeDataOpsReal<DIM> data member.
 *
 ...
 * HierarchyNodeDataOpsComplex<DIM> and HierarchyNodeDataOpsInteger<DIM>, 
 * respectively.
 * 
...
class HierarchyNodeDataOpsReal : public HierarchyDataOpsReal<DIM,TYPE>
{
public:
   /**
    * The constructor for the HierarchyNodeDataOpsReal<DIM> class sets
